...
export { default as IconDrop } from './IconDrop/IconDrop';
...
export { default as IconGavel } from './IconGavel/IconGavel';
export { default as IconGender } from './IconGender/IconGender';
export { default as IconIncreaseSize } from './IconIncreaseSize/IconIncreaseSize';
...
export { WishlistModal as WishlistModal } from './WishlistModal/WishlistModal';
...
export { default as IconThunder } from './IconThunder/IconThunder';
...
export { default as UserTestimonials } from './UserTestimonials/UserTestimonials';
