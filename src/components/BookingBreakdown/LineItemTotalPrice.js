...
const LineItemUnitPrice = props => {
  ...
  const numericPrice = totalPrice.amount / 100
  const summary = isInteger(numericPrice) || !hundredthsIsZero(numericPrice) ? formattedTotalPrice : `${formattedTotalPrice}0`;  
  ...
  return (
    <>
      ...
      <div className={css.lineItemTotal}>
        ...
        <div className={css.totalPrice}>{summary}</div>
      </div>
    </>
  );
};
