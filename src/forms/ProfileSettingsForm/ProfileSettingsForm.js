    ...
    return (
      <FinalForm
        ...
        render={fieldRenderProps => {
          ...
          const FBPictureAlreadySet = user && user.attributes.profile.publicData && user.attributes.profile.publicData.FBPicture
            ...
            >
              <div className={css.sectionContainer}>
                ...
                <Field
                  ...
                  type={FBPictureAlreadySet ? 'text' : 'file'}
                  form={null}
              ...
              <div className={css.sectionContainer}>
                ...
                <div className={css.otherInfoContainer}>
                  ...
                  >
                    <option disabled value="">14 Jahre</option>
                    {Array.from({ length: 66 }, (v, i) => i > 13 ? i : null).map(c => c && (
                      <option key={c} value={c}>{c} Jahre</option>
                    ))}
                    </FieldSelect>
                  <FieldSelect
                    className={css.otherInfo}
                    ...
                    validate={fieldRequired}
                  >
                    <option disabled value="">Keine</option>
                  ...
                  <FieldSelect
                    ...
                    validate={fieldRequired}
                  >
                    <option disabled value="">1 Jahr</option>
                    {Array.from({ length: 31 }, (v, i) => i).map(c => c && (
                      <option key={c} value={c}>{c} {c === 1 ? 'Jahr' : 'Jahre'}</option>
                    ))}
                  </FieldSelect>
                    <FieldSelect
                      className={css.otherInfo}
